...
*/
public class StatisticalSelect_List_Data extends AsyncTask<StatisticalSelect_List_Data_Structure, Void, String[]>
{
    //출력할 리스트 뷰
    ...
    */
    ...
    //백그라운드 실행 (변수 초기화)
    @Override
    protected String[] doInBackground(StatisticalSelect_List_Data_Structure... StatisticalSelect_List_Data_Structures)
    {
        try
        {
            //버전 설정하기 (1: 제목 리스트, 0: 부제목 리스트)
            version = StatisticalSelect_List_Data_Structures[0].version;

            title_num = StatisticalSelect_List_Data_Structures[0].title_num;
            ...
            main_statistical_list_list_view = StatisticalSelect_List_Data_Structures[0].main_statistical_list_list_view;

            main_statistical_list_item_adapter = StatisticalSelect_List_Data_Structures[0].main_statistical_list_item_adapter;

            if(StatisticalSelect_List_Data_Structures[0].version == 2)
            {
    ...
    protected void onPostExecute(String[] result)
    {
        ...
        else if((version == 3) || (version == 4))
        {
            for(int i=0;i<8;i++)
            {
                main_statistical_list_item_adapter.add_item(city_string(i));
            }
        }
