...
*/
public class MainStatisticalList_Data extends AsyncTask<MainStatisticalList_Data_Structure, Void, String[]>
{
    //출력할 리스트 뷰
    ...
    */
    ...
    //백그라운드 실행 (변수 초기화)
    @Override
    protected String[] doInBackground(MainStatisticalList_Data_Structure... MainStatisticalList_Data_Structures)
    {
        try
        {
            //버전 설정하기 (1: 제목 리스트, 0: 부제목 리스트)
            version = MainStatisticalList_Data_Structures[0].version;

            title_num = MainStatisticalList_Data_Structures[0].title_num;
            ...
            main_statistical_list_list_view = MainStatisticalList_Data_Structures[0].main_statistical_list_list_view;

            main_statistical_list_item_adapter = MainStatisticalList_Data_Structures[0].main_statistical_list_item_adapter;

            if(MainStatisticalList_Data_Structures[0].version == 2)
            {
