...
class NationComp_List_Data_Structure
{
    //버전 번호
    int version;
    ...
    NationComp_List_Data_Structure(int version, ListView main_statistical_list_list_view, NationComp_List_Item_Adapter main_statistical_list_item_adapter)
    {
